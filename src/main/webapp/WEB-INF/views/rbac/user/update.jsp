        ...
        <div class="container" style="width: 500px">
            <div class="form-group" style="margin-top: 50px">
                <div class="input-group">
                    ...
                    <input class="form-control" placeholder="username" name="username" value="${user.username}" disabled/>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input class="form-control" placeholder="nickname" name="nicknane" value="${user.nickname}">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
            ...
            <div class="form-group">
                ...
                <c:forEach items="${roleList}" var="roles">
                    <span class="label label-success" style="margin-left:5px">
                        ${roles.name} <input type="checkbox" name="rids" value="${roles.id}" class="rids">
                    </span>
                </c:forEach>
            </div>
            <div class="form-group">
                <div class="input-group" style="margin: auto">
                    <button class="btn btn-success" type="submit"  id="subBtn">提交</button>
                </div>
            </div>
        </div>
    </form>
...
<script type="text/javascript" src="${ctx}/js/gcu/rbac/user/update.js"></script>
